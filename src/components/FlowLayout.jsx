...
const FlowLayout = ({ data }) => {
  return (
    <section className="py-10 font-sans relative">
        ...
        {data.map((item, idx) => (
          ...
          >
            ...
            >
              ...
              <h2 className="text-3xl lg:text-3xl font-black text-[#1a365d]">
                {item.title}
              </h2>
              ...
              {Array.isArray(item.desc) ? (
                ...
                <div
                 className="text-slate-600 text-md font-medium leading-relaxed
