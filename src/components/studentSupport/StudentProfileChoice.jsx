...
const OptionCard = ({ icon, title, body, onClick, disabled }) => (
  <button
    type="button"
    onClick={onClick}
    disabled={disabled}
    className="w-full text-left rounded-2xl border border-gray-100 bg-white p-4 shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:border-[#0066cc]/40 hover:shadow-[0_10px_24px_rgba(0,102,204,0.08)] transition-all disabled:opacity-60"
  >
...
const StudentProfileChoice = ({ age, onAnonymous, onPersonalised, busy }) => {
  return (
