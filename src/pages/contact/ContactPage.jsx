...
export default function ContactUs() {
  ...
  const inputClass =
    "w-full px-5 py-3.5 rounded-2xl bg-slate-50 border-2 border-transparent outline-none transition-all duration-300 focus:border-[#1E88E5] focus:bg-white focus:shadow-[0_4px_12px_rgba(30,136,229,0.08)] text-sm sm:text-base";
  ...
  return (
    ...
    />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="text-center lg:text-left">
              <h2 className="text-2xl lg:text-3xl font-bold text-[#1a365d]">
                Contact Details
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4 lg:space-y-6">
              ...
              <div className="sm:col-span-2 lg:col-span-1">
                <DetailCard
                  icon={<MapPin />}
                  color="bg-orange-50 text-[#FFB300]"
                  title="Our Location"
          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-6 sm:p-10 rounded-[2.5rem] shadow-xl shadow-blue-900/5 border border-slate-50">
              ...
              {status.message && (
                <div
                  className={`p-4 mb-6 rounded-xl text-sm font-bold flex items-center gap-2 ${status.isError ? "bg-red-50 text-red-600 border border-red-100" : "bg-green-50 text-green-600 border border-green-100"}`}
                >
                  {status.isError ? (
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <Button
                  ...
                  className="w-full py-4 bg-[#1a365d] text-white rounded-2xl font-bold text-base hover:bg-[#1E88E5] transition-all flex items-center justify-center gap-3 shadow-lg active:scale-[0.98] disabled:opacity-70"
                >
      ...
      <section className="bg-white py-10 lg:py-10 border-t border-slate-100 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E88E5] to-[#1a365d]">
              Institutions With Us
            </span>
          </h2>

          <p className="text-md text-slate-600 font-medium mb-10 max-w-2xl mx-auto leading-relaxed">
            Join the MyPeegu ecosystem. Let's work together to create
            environments where psychology leads, technology supports, and
            students thrive.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <Link
              to="/solution/student-development"
              className="w-full sm:w-auto px-8 py-4 rounded-xl bg-slate-50 text-slate-700 font-bold hover:bg-slate-100 transition-colors flex items-center justify-center gap-2 border border-slate-200"
            >
              Explore Solutions
            </Link>
          </div>
...
const DetailCard = ({ icon, color, title, detail }) => (
  <div className="flex items-center gap-4 p-4 lg:p-6 bg-white rounded-3xl border border-slate-50 shadow-sm hover:shadow-md transition-all duration-300 group hover:-translate-y-1">
    <div
      className={`w-12 h-12 lg:w-14 lg:h-14 rounded-2xl flex-shrink-0 flex items-center justify-center ${color} transition-transform group-hover:scale-110`}
    >
    ...
    <div className="min-w-0">
      ...
      <p className="text-sm lg:text-lg font-bold text-[#1a365d] truncate">
        {detail}
      </p>
    </div>
  </div>
